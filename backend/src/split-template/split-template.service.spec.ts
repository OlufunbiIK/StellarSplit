...
describe('SplitTemplateService', () => {
  ...
  describe('findOne', () => {
    it('should return a template by id', async () => {
      ...
      expect(repository.findOneBy).toHaveBeenCalledWith({ id: templateId });
      expect(result).toEqual(mockTemplate);
    });
  });
  ...
  describe('update', () => {
    it('should update a template', async () => {
      ...
      expect(repository.update).toHaveBeenCalledWith(templateId, updateDto);
  ...
  describe('createSplitFromTemplate', () => {
    ...
    it('should apply overrides when provided', async () => {
      ...
      const result = await service.createSplitFromTemplate(templateId, overrideDto);
    ...
    it('should throw NotFoundException when template not found', async () => {
      ...
      await expect(service.createSplitFromTemplate(templateId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
