...
describe('RecurringSplitsController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<RecurringSplitsController>(RecurringSplitsController);
  ...
  describe('getRecurringSplitsByCreator', () => {
    it('should return all recurring splits for a creator', async () => {
      ...
      expect(mockService.getRecurringSplitsByCreator).toHaveBeenCalledWith(creatorId);
    });
  });
  ...
  describe('getStats', () => {
    it('should return statistics for a creator', async () => {
      ...
      expect(mockService.getRecurringSplitStats).toHaveBeenCalledWith(creatorId);
    });
  });
  ...
  describe('getRecurringSplitById', () => {
    it('should return a recurring split by ID', async () => {
      ...
      expect(result.id).toBe('recurring123');
      expect(mockService.getRecurringSplitById).toHaveBeenCalledWith('recurring123');
    });
    ...
    it('should throw NotFoundException if not found', async () => {
      ...
      await expect(controller.getRecurringSplitById('nonexistent')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('pauseRecurringSplit', () => {
    it('should pause a recurring split', async () => {
      ...
      expect(mockService.pauseRecurringSplit).toHaveBeenCalledWith('recurring123');
    });
  });
  ...
  describe('resumeRecurringSplit', () => {
    it('should resume a recurring split', async () => {
      ...
      expect(mockService.resumeRecurringSplit).toHaveBeenCalledWith('recurring123');
    });
  });
  ...
  describe('deleteRecurringSplit', () => {
    it('should delete a recurring split', async () => {
      ...
      await expect(controller.deleteRecurringSplit('recurring123')).resolves.toBeUndefined();
      expect(mockService.deleteRecurringSplit).toHaveBeenCalledWith('recurring123');
    });
  });
  ...
  describe('processNow', () => {
    it('should manually process a recurring split', async () => {
      ...
      expect(mockScheduler.manuallyProcessRecurringSplit).toHaveBeenCalledWith('recurring123');
    });
